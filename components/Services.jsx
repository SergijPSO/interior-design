      ...
      <div className="app__services__info">
        <div className="app__services__info-steps">
          ...
          <p className="app__services__info-steps__text">
            ...
            Виїзд на заміри приміщення.<br/>
            Узгодження функціоналу кімнат та стилю інтер’єру.<br/>
            Обговорення кольорів і матеріалів.
          </p>
          <p className="app__services__info-steps__text">
            <span className="app__services__info-steps__number">02</span> 
            Створення обмірного плану, плану демонтажу перегородок.<br/>
            Затвердження плану розташування меблів і обладнання.<br/> 
          ...
          <p className="app__services__info-steps__text">
            ...
            План електрики - виводи точок освітлення,<br/>
            розеток, вимикачів, електровиводів.<br/>
            План виводів води.<br/>
            Схема покриття підлоги.<br/>
            План стелі.
          </p>

          <p className="app__services__info-steps__text">
            <span className="app__services__info-steps__number">04</span>
            Візуалізація кімнат.<br/>
            Розгортки стін у кресленнях.<br/>
            Видача проєкту у роздрукованному і цифровому вигляді.<br/>
            Дистанційна допомога по підбору матеріалів і меблів.<br/>
          ...
          <p className="app__services__info-steps__text">
            01, 02, 03 етапи. <br/> Всі планувальні рішення, креслення без візуалізацій і розгорток стін.
          </p>
